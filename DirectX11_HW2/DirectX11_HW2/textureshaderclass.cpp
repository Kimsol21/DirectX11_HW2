...
bool TextureShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, L"../DirectX11_HW2/texture.vs", L"../DirectX11_HW2/texture.ps");
	if(!result)
	{
		return false;
	}
...
bool TextureShaderClass::SetFilteringMode(ID3D11Device* device, int mode)
{
	D3D11_SAMPLER_DESC samplerDesc;
	HRESULT result;
